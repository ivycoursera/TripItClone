...
const updateUI = async () => {
  ...
  try {
    ...
    document.getElementById(
      "place",
    ).innerHTML = `The weather forecast for <strong><u>${allData[0].userResponse}</u></strong>, zipcode: ${zip}`;
    document.getElementById("date").innerHTML = `on ${newDate}`;
    document.getElementById(
      "temp",
    ).innerHTML = `is ${allData[0].temperature} degrees Farenheit with ${allData[0].message}!`;
